...
vector<wstring> WordPieceTokenizer::wordpiece_tokenize(const wstring& input_text)
{
...
vector<size_t> WordPieceTokenizer::convert_tokens_to_ids(const vector<wstring>& input_seq)
{
